...
export function MenuPage({ menuItems, categories, onAddToCart }: MenuPageProps) {
  ...
  // Filter categories shown based on food vs drink
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12 font-sans text-neutral-200">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-xs sm:text-sm text-neutral-400 leading-relaxed font-light">
          Explore all 35 authentic offerings priced strictly in Rwandan Francs (RWF). Every plate and vintage is crafted to exceed highest standards of taste and refinement.
        </p>
      </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-[#0D0C0B] border border-neutral-700 rounded-xl text-xs text-white placeholder-neutral-500 focus:outline-none focus:border-[#D4AF37] transition-colors"
            />
          </div>
        </div>
      ...
      {filteredItems.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredItems.map((item) => (
            <div
              key={item.id}
              className="bg-[#141312] border border-neutral-800 hover:border-[#D4AF37]/60 rounded-2xl overflow-hidden group flex flex-col justify-between transition-all duration-300 hover:shadow-[0_10px_25px_rgba(0,0,0,0.6)]"
            >
              {/* Card Image */}
              <div className="relative aspect-[16/10] overflow-hidden bg-neutral-900">
                ...
                <div className="absolute top-3 left-3 bg-[#0D0C0B]/90 backdrop-blur-md px-2 py-0.5 rounded text-[10px] font-mono uppercase text-neutral-300 border border-neutral-800">
                  {item.type}
                </div>
              </div>
              ...
              <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                ...
                <div className="pt-4 border-t border-neutral-800/80 flex items-center justify-between">
                  <div className="text-[11px] font-mono text-neutral-400">
                    <span>Authentic Kigali Cut</span>
                  </div>
